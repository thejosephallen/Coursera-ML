...
plot(1:numel(J_history4), J_history4, 'k');
legend('a=.01', 'a=.03', 'a=.09', 'a=.27');

title('Convergence Using Various Learning Rates');
xlabel('Number of iterations');
ylabel('Cost J');

% Display gradient descent's result
fprintf('Theta computed from gradient descent: \n');
fprintf(' %f \n', theta4); %theta4 from best learning rate
fprintf('\n');
...
% Normalized Input with prepended 1
